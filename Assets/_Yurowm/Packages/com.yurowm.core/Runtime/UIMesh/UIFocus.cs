    ...
    public class UIFocus : MaskableGraphic, ILayoutElement {
        ...
        void GenerateMesh(VertexHelper vh) {
            ...
            AddQuad(vh,
                ...
                color,
                new Vector2(outer.z, outer.y - extraBorderUV),
                
                new Vector2(outer.z + extraBorderUV, outer.y));
            ...
            AddQuad(vh,
                ...
                color,
                new Vector2(outer.x - extraBorderUV, outer.w),
                new Vector2(outer.x, outer.w + extraBorderUV));
