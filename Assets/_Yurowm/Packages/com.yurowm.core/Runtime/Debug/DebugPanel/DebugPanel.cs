...
namespace Yurowm.DebugTools {
	public static class DebugPanel {
		...
		static Dictionary<int, Entry> entries = new Dictionary<int, Entry>();
		
		static Dictionary<string, List<Entry>> groups = new Dictionary<string,List<Entry>>();
		...
		static readonly Color errorColor = new Color(1f, .5f, .5f);
		static readonly Color systemColor = new Color(.5f, 1f, .5f);
		static readonly Color warningColor = new Color(1f, 1f, .3f);
		static readonly Color logColor = new Color(0.5f, 1f, 1f);
		static readonly Color untitledColor = new Color(0.8f, 0.8f, 0.8f);
