...
namespace Yurowm.ContentManager {
    ...
    [DashboardTab("Assets", "ContentTabIcon", "tab.assets",-9999)]
    public class AssetManagerEditor : DashboardEditor<AssetManager> {
        ...
        public override bool Initialize() {
            ...
            metaTarget.aItems = metaTarget.aItems
                .Where(i => i.item != null)
                .Distinct()
                .ToList();
        ...
        void Sort() {
            metaTarget.aItems.Sort((x, y) => String.Compare(x.item.name, y.item.name, StringComparison.Ordinal));
