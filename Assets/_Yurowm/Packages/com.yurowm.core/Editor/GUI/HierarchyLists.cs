...
namespace Yurowm.HierarchyLists {
    public abstract class HierarchyList<I, F> : TreeView {
        ...
        public Dictionary<int, IInfo> info = new Dictionary<int, IInfo>();
        public Dictionary<string, F> folders = new Dictionary<string, F>();
        ...
        protected override DragAndDropVisualMode HandleDragAndDrop(DragAndDropArgs args) {
            if (!_isDrag) {
                ...
                IInfo[] selected = DragAndDrop.GetGenericData(typeof(I).FullName) as IInfo[];
                if (selected != null) drag.AddRange(selected);
            }
